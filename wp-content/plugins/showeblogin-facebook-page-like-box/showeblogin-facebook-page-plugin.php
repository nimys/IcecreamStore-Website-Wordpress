...
Plugin URI: http://www.facebook.com/blogger-beginner-guide/facebook-page-wordpress-plugin/
...
class ShowebloginFacebookPagePlugin extends WP_Widget 
{
    ...
    function widget($args, $instance)
    {
        ...
        <?php  if ( $title ) {  ?> <h4 class="widgettitle"><?php echo $title; ?></h4> <?php }  ?>
                ...
                <table width="100%">
					...
					<tr>
                        ...
                        <td class="swt-fb-page-widget-content">
							...
							Customize:<br /> <textarea rows="5" cols="40">[swt-fb-likebox url="https://www.facebook.com/SuperWebTricks" width="340" height="500" small_header="false" show_faces="true" data_hide_cta="true" stream="false" ]</textarea> 
                        </td>
                    </tr>                     
                </table>
            </div>            
...
function swt_fb_add_shortcode( $atts ) {
	...
	$html='<div class="fb-page" data-href="'.$url.'" small-header="'.$small_header.'" data-hide-cta="'.$data_hide_cta.'" data-show-facepile="'.$show_faces.'" data-show-posts="'.$stream.'" data-width="'.$width.'" data-height="'.$height.'"></div>';
	return $html;
}
